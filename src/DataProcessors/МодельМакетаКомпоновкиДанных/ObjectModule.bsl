...
Функция Настройки(Настройки) Экспорт
	НастройкиКомпновкиДанных = Настройки;
	Возврат ЭтотОбъект;
КонецФункции
...
Функция Скомпоновать(Расшифровка = Неопределено) Экспорт
	ДанныеРасшифровки = Новый ДанныеРасшифровкиКомпоновкиДанных();
	КомпоновщикМакета = Новый КомпоновщикМакетаКомпоновкиДанных();
	МакетКомпоновкиДанных = КомпоновщикМакета.Выполнить(СхемаКомпоновкиДанных, НастройкиКомпновкиДанных, ДанныеРасшифровки);
...
Функция ВывестиВТабличныйДокумент(Результат) Экспорт
	...
	ПроцессорКомпоновки.Инициализировать(МакетКомпоновкиДанных, , ДанныеРасшифровки, , , МенеджерВременныхТаблиц);
